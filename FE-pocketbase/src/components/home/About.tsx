    ...
    <section id="about" className="bg-[#EBE7DE]">
      ...
      <div className="py-24 px-6 md:px-12 max-w-[1800px] mx-auto flex flex-col md:flex-row items-start gap-16 md:gap-32">
        <div className="md:w-1/3">
          <h2 className="text-4xl md:text-6xl font-serif text-[#2C2A26] leading-tight md:leading-none">
            Born from the earth, <br/> built for the mind.
          </h2>
        </div>
        <div className="md:w-2/3 max-w-2xl">
          <p className="text-lg md:text-xl text-[#5D5A53] font-light leading-relaxed md:leading-7 mb-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[80vh]">
        ...
        <div className="order-1 lg:order-2 flex flex-col justify-center p-12 lg:p-24 bg-[#D6D1C7]">
           ...
           <h3 className="text-4xl md:text-5xl font-serif mb-8 text-[#2C2A26] leading-tight md:leading-none">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[80vh]">
        <div className="flex flex-col justify-center p-12 lg:p-24 bg-[#2C2A26] text-[#F5F2EB]">
           ...
           <h3 className="text-4xl md:text-5xl font-serif mb-8 text-[#F5F2EB] leading-tight md:leading-none">
             Silence by default.
           </h3>
